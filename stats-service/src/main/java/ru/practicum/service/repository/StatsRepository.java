...
public interface StatsRepository extends JpaRepository<EndpointHit, Long> {
    ...
    List<ViewStatsDto> findNonUniqueStats(LocalDateTime start, LocalDateTime end, List<String> uris);
    ...
    @Query("SELECT new ru.practicum.dto.ViewStatsDto(h.app, h.uri, COUNT(DISTINCT h.ip)) " +
            ...
            "GROUP BY h.app, h.uri " +
            "ORDER BY COUNT(DISTINCT h.ip) DESC")
    List<ViewStatsDto> findUniqueStatsWithoutUris(LocalDateTime start, LocalDateTime end);
    ...
    @Query("SELECT new ru.practicum.dto.ViewStatsDto(h.app, h.uri, COUNT(h.ip)) " +
            ...
            "GROUP BY h.app, h.uri " +
            "ORDER BY COUNT(h.ip) DESC")
    List<ViewStatsDto> findNonUniqueStatsWithoutUris(LocalDateTime start, LocalDateTime end);
}